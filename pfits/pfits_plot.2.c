...
void drawPlot(int nFiles,int fileNum,dSetStruct **dSet,plotStruct **plot,float **plotArr_p0,
	      float **plotArr_p1,float **plotarr_p2,float **plotArr_p3);
void drawColourMap(dSetStruct *dSet,plotStruct *plot,float *plotArr_p0,
		   float *plotArr_p1,float *plotArr_p2,float *plotArr_p3);
...
void doPlot(dSetStruct **dSet,int nFiles,plotStruct **plot,int debug)
{
  ...
  do {
      ...
      for (k=0;k<nFiles;k++)
	{
	  ...
	  drawPlot(nFiles,k,dSet,plot,plotArr_p0,plotArr_p1,plotArr_p2,plotArr_p3);
	}
	      ...
	      float **plotArr_p1,float **plotArr_p2,float **plotArr_p3)
{
  if (dSet[fileNum]->head->nchan > 1)
    {
      drawColourMap(dSet[fileNum],plot[fileNum],plotArr_p0[fileNum],plotArr_p1[fileNum],plotArr_p2[fileNum],plotArr_p3[fileNum]);
    }
}
  ...
  if (plot->colourPlot==1)
    {
      ...
      cpgimag(plotArr_p0,nchan,plot->nTimeSamples,1,nchan,1,plot->nTimeSamples,plot->minVal,plot->maxVal,tr);
    }
  else
    cpggray(plotArr_p0,nchan,plot->nTimeSamples,1,nchan,1,plot->nTimeSamples,plot->minVal,plot->maxVal,tr);
